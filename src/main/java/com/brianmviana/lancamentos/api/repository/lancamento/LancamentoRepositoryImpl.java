...
import com.brianmviana.lancamentos.api.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		Predicate[] predicates = criarRestricoes(lancamentoFilter, builder, root);//criar restrições
		criteria.where(predicates);//adiciona as restricoes
